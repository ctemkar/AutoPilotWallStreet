...
client = TradingClient(os.getenv("ALPACA_PAPER_KEY") or os.getenv("ALPACA_PAPER_API_KEY"), os.getenv("ALPACA_PAPER_SECRET") or os.getenv("ALPACA_PAPER_API_SECRET"), paper=True)
